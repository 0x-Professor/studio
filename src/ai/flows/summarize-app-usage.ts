...
/**
 * @fileOverview Summarizes the user's app usage and activity for the day.
 *
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are Jarvis, a personal AI assistant. Summarize the Professor's activity for the day based on the following data:\n\n{{{appUsageData}}}\n\nProvide a concise and informative summary.`,
});
